...
export default function Page() {
  return <p>I am too lazy to finish this</p>;
}
...
//         await getPokemon(response.data.results[randomnumber]?.url!, 1);
//         await getPokemon(response.data.results[randomnumber2]?.url!, 2);
//       });
//   }
//   async function taller(e: React.SyntheticEvent) {
...
//     await getRandomPokemon();
//   }
//   async function getPokemon(url: string, number: number) {
//     switch (number) {
//       case 1: {
//         await axios.get(url).then(function (response: Response) {
//           setPokemon({
